...
| App Screenshot | App Description |
| --- | --- |
| ![NewsReader] | This app retrieves Android articles from the Guradian's [API Endpoint](https://content.guardianapis.com/search?q=android&api-key=test&show-references=author) <br><br> It demonstrates the use of: <br>    - ; <br>    - ; <br>    - . <br><br> **Note:** target API level is 28 (Android 9), although this app supports the minimum API level of 24 (Android 7.0).|
